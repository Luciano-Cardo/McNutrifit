...
export default function Footer() {
  return (
    <footer className="bg-black border-t border-zinc-800" style={{paddingLeft: '24px', paddingRight: '24px'}}>
      ...
      {/* Columnas principales — estilo Adidas */}
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-6 md:gap-8">
          ...
          <div>
            ...
            <ul className="flex flex-col gap-3">
              ...
              <li><Link to="/mis-productos" className="text-gray-400 hover:text-white text-sm transition">Mis planes</Link></li>
          ...
          {/* Col 2: Planes */}
          <div>
            <h4 className="text-white font-black text-xs uppercase tracking-widest mb-5">Planes</h4>
            <ul className="flex flex-col gap-3">
          ...
          <div>
            ...
            <ul className="flex flex-col gap-3">
              <li>
                <a href="https://wa.me/5491100000000" target="_blank" rel="noreferrer" className="text-gray-400 hover:text-white text-sm transition">
                  WhatsApp
                </a>
              </li>
              <li>
              ...
              <li><Link to="/productos" className="text-gray-400 hover:text-white text-sm transition">Ver productos</Link></li>
              <li><Link to="/carrito" className="text-gray-400 hover:text-white text-sm transition">Mi carrito</Link></li>
              <li><Link to="/mis-productos" className="text-gray-400 hover:text-white text-sm transition">Mis compras</Link></li>
            </ul>
          </div>
 
          {/* Col 4: La empresa */}
          <div>
            <h4 className="text-white font-black text-xs uppercase tracking-widest mb-5">La empresa</h4>
            <ul className="flex flex-col gap-3">
              <li><span className="text-gray-400 text-sm">Acerca de MCNutriFit</span></li>
              <li><span className="text-gray-400 text-sm">Nuestro equipo</span></li>
              <li><span className="text-gray-400 text-sm">Profesionales</span></li>
              <li><span className="text-gray-400 text-sm">Resultados reales</span></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-4">
              <li>
                <a href="#" target="_blank" rel="noreferrer" className="flex items-center gap-3 text-gray-400 hover:text-white text-sm transition">
                  {/* Instagram */}
              ...
              <li>
                <a href="https://wa.me/5491100000000" target="_blank" rel="noreferrer" className="flex items-center gap-3 text-gray-400 hover:text-green-400 text-sm transition">
                  {/* WhatsApp */}
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="border-t border-zinc-800 py-5 px-10">
        <div className="flex flex-col md:flex-row items-center justify-center gap-2 flex-wrap">
          <span className="text-gray-600 text-xs">Política de Privacidad</span>
          <span className="text-zinc-700 hidden md:inline">|</span>
          <span className="text-gray-600 text-xs">Términos y Condiciones</span>
          <span className="text-zinc-700 hidden md:inline">|</span>
          <span className="text-gray-600 text-xs">Política de Cookies</span>
        </div>
