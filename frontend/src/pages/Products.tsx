...
export default function Products() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-10" style={{paddingTop: '16px', paddingBottom: '16px'}}>

      <h1 className="text-3xl font-bold text-white mb-2 text-center">Nuestros planes</h1>
          ...
          {products.map(product => (
            ...
            >
              ...
              <div className="p-5">
                ...
                <h2
                  className="text-white font-bold text-lg mt-1 mb-2 cursor-pointer hover:text-red-400 transition"
                  onClick={() => navigate(`/productos/${product.id}`)}
                >
                  {product.name}
                </h2>
